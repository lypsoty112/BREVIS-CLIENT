...
<div class="container mx-auto p-4">
	...
	<div class="my-4 flex md:justify-end">
		<div class="card card-hover p-4 w-full md:w-4/6 variant-glass-primary">
			<header class="card-header font-bold">Leverage A.I. to your advantage</header>
			<section class="p-4 md:flex">
				<div class="w-2/4 md:w-1/4 mx-auto">
	...
	<div class="my-4">
		<div class="card card-hover p-4 w-full variant-glass-primary">
			...
			<section class="p-4 md:flex">
				...
				<div class="w-full md:w-1/4 my-4 flex align-middle items-center justify-center">
					<a href="/register"
						><button class="btn variant-filled-secondary m-auto">Register</button></a
					>
				</div>
			</section>
		</div>
